    ...
    <tr className='hover:bg-gray-50'>
      ...
      <td className='py-4 px-6'>
        <div 
          ...
          className='text-sm font-medium text-blue-600 truncate max-w-xs cursor-pointer hover:underline'
        >
          {title}
        </div>
        {blog.username && (
          <div className='text-xs text-gray-500'>Submitted by: {blog.username}</div>
        )}
      </td>
